...
Insert and import citations, bibliographies, and notes from Zotero, and import annotations from PDFs. Requires the [Better BibTeX for Zotero](https://retorque.re/zotero-better-bibtex/installation/) plugin.
